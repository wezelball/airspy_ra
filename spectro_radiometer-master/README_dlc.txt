...
Airspy:
spectro_radiometer.py --abw=250e3 --bw=250e3 --device="airspy=0 file=/dev/zero,rate=2.5e6" --frequency=1420.4058e6 --mode=total --srate=1.0e6 --latitude=37.79 --longitude=-77.92

Rtl-sdr
spectro_radiometer.py --abw=250e3 --bw=250e3 --device="rtl=0 file=/dev/zero,rate=5e6" --frequency=1420.4058e6 --mode=total --srate=1.0e6 --latitude=37.79 --longitude=-77.92

The rtl version is working with any overruns, the airspy starts okay
but overruns after several seconds.
